...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        game.innerHTML = `
            ...
            <p class="game-pledged">$${games[i].pledged.toLocaleString()} pledged</p>
            <p class="game-goal">Goal: $${games[i].goal.toLocaleString()}</p>
            <p class="game-backers">${games[i].backers} backers</p>
        `;
...
contributionsCard.innerHTML = `${totalBackers.toLocaleString()} backers`;
...
const displayStr = 
    `A total of $100,000 has been raised for 4 games. Currently, ${unfundedGames} games remain unfunded. We need your help to fund these amazing games!`;
